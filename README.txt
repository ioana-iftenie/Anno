Pasii ce trebuie urmati ca sa facem push pe git (adica sa ducem fisierele modificate pe proiectul local in repositorul de pe git):
...
6. git add . - adaugam toate fisierele locale intr-un stash ce urmeaza sa fie comise si apoi uploadat.
